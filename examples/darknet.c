...
int target_length;
char *target_folder;
int softmax_Temperature=1;
int partial_weights;
int multiloss_cost=0;

//
extern void run_KD_regressor(int argc, char **argv);
extern void run_multiloss_detector(int argc, char **argv);
extern void run_multiloss_region_detector(int argc, char **argv);
//
...
int main(int argc, char **argv)
{
    ...
    else if (0 == strcmp(argv[1], "kd_regressor")){
        run_KD_regressor(argc, argv);
    }
    else if (0 == strcmp(argv[1], "multiloss_detector")){
        run_multiloss_detector(argc, argv);
    }     
    else if (0 == strcmp(argv[1], "multiloss_region_detector")){
        run_multiloss_region_detector(argc, argv);
    }     
