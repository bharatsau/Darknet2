...
void forward_detection_layer(const detection_layer l, network net)
{
    ...
    if(get_current_batch(&net)%100 == 0)
        fprintf(stderr,"Iteration %d: Avg IOU: %f, Pos Cat: %f, All Cat: %f, Pos Obj: %f, Any Obj: %f, count: %d\n", get_current_batch(&net), avg_iou/count, avg_cat/count, avg_allcat/(count*l.classes), avg_obj/count, avg_anyobj/(l.batch*locations*l.n), count);
