...
{
    fprintf(stderr, "eltwise  %3d            %4d x%4d x%4d   ->  %4d x%4d x%4d\n",index, w2,h2,c2, w,h,c);
    if(h != h2 || w != w2 || c != c2) error("Dimensions do not match");
    ...
    l.forward = forward_eltwise_layer;
    l.backward = backward_eltwise_layer;
    #ifdef GPU
    l.forward_gpu = forward_eltwise_layer_gpu;
    l.backward_gpu = backward_eltwise_layer_gpu;
...
void forward_eltwise_layer(const layer l, network net)
{
    ...
    eltwise_cpu(l.batch, l.w, l.h, l.c, net.layers[l.index].output, l.out_w, l.out_h, l.out_c, l.output, l.sum, l.mult);
...
void forward_eltwise_layer_gpu(const layer l, network net)
{
    ...
    eltwise_gpu(l.batch, l.w, l.h, l.c, net.layers[l.index].output_gpu, l.out_w, l.out_h, l.out_c, l.output_gpu, l.sum, l.mult);
